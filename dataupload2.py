...
PRIVATE_KEY = "f3442a734a-private.pem.key"

# The relative path to your certificate file that 
# &IoT; generated for this device, which you 
# have already saved onto this device.
CERT_FILE = "f3442a734a-certificate.pem.crt"

# A programmatic shadow handler name prefix.
SHADOW_HANDLER = "A0105714N_FD004"
...
data = pd.read_csv('train_FD004.txt', header=None, delim_whitespace=True)
...
data['id'] = data['id'].map(lambda s: 'FD004_'+str(s))
